package com.seasia.driverapp.maps
...
internal constructor(
...
) : ArrayAdapter<AutocompletePrediction>(context, android.R.layout.simple_list_item_activated_2, android.R.id.text1),
    Filterable {
    /**
    ...
    override fun getView(position : Int, convertView : View?, parent : ViewGroup) : View {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            textView1.setTextAppearance(parent.context, android.R.style.TextAppearance_DeviceDefault_Medium)
            textView2.setTextAppearance(parent.context, android.R.style.TextAppearance_DeviceDefault_Small)
        } else {
