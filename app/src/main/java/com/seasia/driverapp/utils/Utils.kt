...
class Utils(internal var context: Context) {
    ...
    fun compareIfPreviousDate(checkIfPreviousDate: String): Boolean {
        val sdf = SimpleDateFormat("dd-MMM-yyyy")
        val strDate = sdf.parse(checkIfPreviousDate)
    ...
    fun formattedDate(dateStr: String, inFormat: String, outFormat: String): String {
//        val inFormat = "dd/MM/yyyy"
//        val outFormat = "MMMM dd, yyyy"
        val curFormater = SimpleDateFormat(inFormat)
        val dateObj = curFormater.parse(dateStr)
        val postFormater = SimpleDateFormat(outFormat)
